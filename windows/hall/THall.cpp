...
void THall::paintEvent(QPaintEvent *event) {
	QPainter p(this);
...
void THall::mousePressEvent(QMouseEvent *event) {
...
void THall::mouseMoveEvent(QMouseEvent *event) {
...
void THall::mouseReleaseEvent(QMouseEvent *event) {
	Q_UNUSED(event)
...
void THall::swapIf(int &i1, int &i2) {
	int t = qMin(i1, i2);
	i2 = qMax(i1, i2);
	i1 = t;
}
